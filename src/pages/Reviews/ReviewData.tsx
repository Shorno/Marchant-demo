...
import QualityIcon from "../../components/shared/QualityIcon.tsx";
import ClockIcon from "../../components/shared/ClockIcon.tsx";
...
export const reviewsCategory: ReviewCategories = [
    {
